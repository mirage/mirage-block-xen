...
(* OASIS_START *)
(* DO NOT EDIT (digest: b720cf307d68cc81024c5d28dfccd67e) *)
(*
...
let setup_t =
  {
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "build the kernelspace only code";
     ...
     oasis_version = "0.3.1";
     oasis_digest = Some ",\179\177x\004\227\209(\0274\248\145\163\172\236^";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
