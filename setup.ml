...
(* OASIS_START *)
(* DO NOT EDIT (digest: dc980fa09b12792a23904a8757a50e79) *)
(*
...
let setup_t =
  {
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "build the kernelspace code";
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "build the userspace code";
                      flag_default = [(OASISExpr.EBool true, false)];
                      });
               Library
                 ({
                     ...
                     },
                   {
                      bs_build =
                        [
                           (OASISExpr.EBool true, false);
                           (OASISExpr.EOr
                              (OASISExpr.EFlag "kernelspace",
                                OASISExpr.EFlag "userspace"),
                             true)
                        ];
                      bs_install =
                        [
     ...
     oasis_version = "0.3.1";
     oasis_digest = Some "\209Wq\215d\244\007\1522\003\2247v\017\233e";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
