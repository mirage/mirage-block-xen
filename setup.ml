...
(* OASIS_START *)
(* DO NOT EDIT (digest: 7727de208c1172213ed276e9dec7a8a1) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Blkproto"; "Device_number"; "S"];
                      lib_pack = false;
     ...
     oasis_version = "0.4.1";
     oasis_digest = Some "\249`\027Rb\218\006\153\030\231\007\255\244\002cL";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
